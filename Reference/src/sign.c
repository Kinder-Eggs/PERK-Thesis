...
void genCommitment(signature* signature, instance instances[TAU], uint8_t pi[N1], uint16_t h[M][N1]) {
    ...
    #ifdef KAT
    memcpy(random, (uint8_t[]){0x9b, 0x4e, 0x44, 0x1b, 0xd6, 0xa7, 0x49, 0x87, 0x77, 0x99, 0xfb, 0x71, 0x1d, 0x6d, 0x1f, 0x45, 0x5e, 0x2c, 0xab, 0x5b, 0x57, 0x66, 0xa6, 0x45, 0x15, 0xd7, 0xc7, 0xad, 0x3e, 0xb6, 0x75, 0xc0, 0xfd, 0x08, 0xee, 0xbb, 0xeb, 0xbe, 0x66, 0x9b, 0xae, 0x60, 0x01, 0x86, 0x54, 0x38, 0xd8, 0x9e}, sizeof(random));
    #else
